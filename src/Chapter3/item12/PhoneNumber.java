...
public class PhoneNumber {
	 ...
	 * (Items 10 and 11), providing a good toString implementation makes your class
	 * much more pleasant to use and makes systems using the class easier to debug
	 * 
	 * Genel olarak hata ayıklamasını kolaylaştırır,düzgün okunabilir çıktılar
	 * üretir.
	 * 
	 */
	...
	public boolean equals(Object o) {
		if (o == this)
			return true;
		if (!(o instanceof EffectiveJava.chapter3.item11))
			return false;
